...
protected:
	...
	/* Allows the window to maximize. Resizing must also be enabled. */
	UPROPERTY(EditAnywhere, Category = "Draggable Window Widget", meta = (EditCondition = "bEnableResizing"))
...
public:
	...
	**/
	...
	static UDraggableWindow* CreateDraggableWindowFromWidget(const UObject* WorldContextObject, TSubclassOf<UDraggableWindow> WindowClass,
...
public:
	...
	/**
	 * public UDraggableWindow::CloseWindow
...
protected:
	...
	**/
	...
	/**
	 * protected UDraggableWindow::ToggleMaximize
	 * Maximizes or restores this window.
	 * @return [bool] True if the window was maximized or restored.
	 */
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, Category = "Draggable Window", meta = (Keywords = "fullscreen, restore"))
	bool ToggleMaximize();
...
protected:
	...
	**/
	...
	/**
	 * protected UDraggableWindow::K2_StartMinimized
	 * Event called when the window starts minimized.
	 */
	UFUNCTION(BlueprintImplementableEvent, BlueprintCosmetic, Category = "Draggable Window", DisplayName = "On Start Minimized")
	void K2_StartMinimized();

	/**
	 * protected UDraggableWindow::K2_OnWindowMaximizeToggled
	 * Event called when this window is maximized or restored.
	 */
	UFUNCTION(BlueprintImplementableEvent, BlueprintCosmetic, Category = "Draggable Window", DisplayName = "On Window Maximize Toggled")
